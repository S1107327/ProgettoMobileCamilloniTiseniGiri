...
class FragmentRicerca: Fragment(R.layout.fragment_ricerca) {
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val rvRicerca: RecyclerView = view.findViewById(R.id.recyclerViewRicerca)
        rvRicerca.layoutManager = GridLayoutManager(context,2)
        rvRicerca.adapter = PopularAdapter(mutableListOf<Corsi>(corso1,corso2,corso3,corso4,corso5,corso6,corso7,corso8,corso9,corso10))
    }
}